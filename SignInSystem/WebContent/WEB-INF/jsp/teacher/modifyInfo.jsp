...
$(document).ready(function() {
	$("#oldPwd").blur(function() {
		...
		if (oldPwd == null || oldPwd == "") {
			...
			$.ajax({
				//请求路径
				url : "${pageContext.request.contextPath }/teacher/yanzhengTpwdJson",
				//请求类型
				type : "post",
				//data表示发送的数据
				data : JSON.stringify({tpwd:oldPwd}),
				//定义发送请求的数据格式为JSON字符串
...
<div style="padding:100px 50px 10px">
	<div class="panel-group" id="accordion">
		...
		<div class="panel panel-success" >
			...
			<div id="collapseTwo" class="panel-collapse collapse">
				...
				<span>${msgTel}当前电话：${Teacher.ttel}</span>
					<form:form action="modifyTel"  modelAttribute="teacher" method="post">
					<div class="form-group">
						<form:input path="ttel" class="form-control"/>
						</div>
						<div class="form-group">
		...
		<div class="panel panel-info">
			...
			<div id="collapseThree" class="panel-collapse collapse">
				<div class="panel-body" style="text-align:center">
				<span>${msgPwd}</span>
					<form:form action="modifyPwd"  modelAttribute="teacher" method="post" name="modifyPwd">
						<input type="password" class="form-control" placeholder="原密码" id="oldPwd">
						<div id="oldPwdDiv" style="display: inline"></div><br>
						<form:password path="tpwd"  class="form-control" placeholder="新密码" id="newPwd1"/><br>
 ...
 <p>欢迎${Teacher.tname}<a href="exit" class="btn btn-primary" role="button">注销</a></p>
<script>
